...
let unfunded_length = unfunded.length;
// create a string that explains the number of unfunded games using the ternary operator
const displayStr = `A total of $${amountRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${unfunded_length > 0 ? unfunded_length + " game remains unfunded. We need your help to fund these amazing games!" : "All games have been funded"} `

// create a new DOM element containing the template string and append it to the description container

let fundInfo = document.createElement('p')
fundInfo.innerHTML = displayStr
